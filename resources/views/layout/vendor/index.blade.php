...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('files/admin/css/vendors/select2.css')}}">
  ...
  <body onload="startTime()" class="{{ app() -> getLocale() === 'ar' ? 'rtl' : ' ' }}">
    ...
    <script src="{{asset('files/admin/js/ecommerce.js')}}"></script>
    ...
    <script src="{{asset('files/admin/js/select2/select2.full.min.js')}}"></script>
    <script src="{{asset('files/admin/js/select2/select2-custom.js')}}"></script>
    ...
    <!-- <script src="{{asset('files/admin/js/dropzone/dropzone.js')}}"></script>
    <script src="{{asset('files/admin/js/dropzone/dropzone-script.js')}}"></script> -->

                        ...
                        <div class="nov-html col-xl-4 col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <p class="logo-footer"><img src="{{asset('files/front/img/logo-footer.png')}}" alt="logo" width="167" height="23"></p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="payment-image col-md-6 align-items-center justify-content-md-end justify-content-sm-center d-flex flex-center">
                    <img class="img-fluid" src="{{asset('files/front/img/payment-logo-1.png')}}" alt="payment" title="Payment">
                </div>
            </div>
        </div>
    </div>

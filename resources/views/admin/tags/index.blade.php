                                                    ...
                                                    <td>
                                                        @if($tag->is_activate == 1)
                                                            <button class="btn btn-primary btn-xs" type="button">
                                                                <a href="{{route('tags/deactivate',$tag->id)}}" style="text-decoration:none;color:white;">ِActivate</a>
                                                            </button>
                                                        @else
                                                            <button class="btn btn-primary btn-xs" type="button">
                                                                <a href="{{route('tags/activate',$tag->id)}}" style="text-decoration:none;color:white;">DeActivate</a>
                                                            </button>
                                                        @endif
                                                    </td>
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form role="form" action="{{url(route('tags/delete',$tag->id))}}" class="" >
                                                        ...
                                                        <div class="modal fade" id="myModalEdit-{{ $tag->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="card" action="{{route('tags/update',$tag -> id)}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal fade" id="myModalLangar-{{ $tag->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="card" action="{{route('tags/lang/ar',$tag -> id)}}" method="post">
                                                        ...
                                                        <div class="modal fade" id="myModalLanges-{{ $tag->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="card" action="{{route('tags/lang/es',$tag -> id)}}" method="post">

...
@section('title')
    {{__('admin/categories.subcategories')}}
@endsection
@section('content')
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h3>{{__('admin/categories.subcategories')}}</h3>
                    </div>
                    <div class="col-6">
                        <ol class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <h4>{{__('admin/categories.subcategories_list')}} </h4>
                        </div>
                        @isset($categories)
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>{{$category->name}}</td>
                                                    <td>{{$category->slug}}</td>
                                                    <td>{{optional($category->_parent)->name}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <button class="btn btn-primary btn-xs" type="button">
                                                                <a href="{{url(route('main-categories-activate',$category->id))}}" style="text-decoration:none;color:white;">{{__('admin/categories.parent')}}deactivate</a>
                                                            </button>
                                                        @endif
                                                    </td>
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form role="form" action="{{url(route('sub-categories-delete',$category->id))}}" class="" >
                                                                            <input name="_method" type="hidden" value="DELETE">
                                                                            {{ csrf_field() }}
                                                                            <p>{{__('admin/categories.delete_sure')}}</p>
                                                                            <button type="submit" class="btn btn-danger" name='delete_modal'><i class="fa fa-trash" aria-hidden="true"></i> {{__('admin/categories.delete')}}</button>
                                                        ...
                                                        <div class="modal fade" id="myModalEdit-{{ $category->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title" id="myModalLabel">{{__('admin/categories.subcategories')}}</h4>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form class="card" action="{{route('sub-categories-update',$category -> id)}}" method="post">
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-12">
                                                                                        <div class="form-group col-sm-12 mb-3 mr-5">
                                                                                        <label for="projectinput1">{{__('admin/categories.main_category')}}</label>
                                                                                            <select name="parent_id" class="select2 form-control">
                                                                                                <optgroup label="">
                                                                                                    @if($parentcategories && $parentcategories -> count() > 0)
                                                                                                        @foreach($parentcategories as $main)
                                                        ...
                                                        <div class="modal fade" id="myModalLangar-{{ $category->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="card" action="{{route('sub-categories-lang/ar',$category -> id)}}" method="post">
                                                        ...
                                                        <div class="modal fade" id="myModalLanges-{{ $category->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="card" action="{{route('sub-categories-lang/es',$category -> id)}}" method="post">

        ...
        <div class="row">
            <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <section id="main">
                    ...
                    <div class="row">
                        <form class="needs-validation" method="Post" action="{{route('user/acount/update', auth()->guard('user')->user()->id)}}" enctype="multipart/form-data" novalidate="">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="email" id="email" value="{{auth()->guard('user')->user()->email}}" required="">
                                    @error('email')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-5">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="phone" id="phone" value="{{auth()->guard('user')->user()->phone}}" required="">
                                    @error('phone')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>

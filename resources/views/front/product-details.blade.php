                ...
                <div class="row no-gutters">
                    <div class="col-md-5 col-sm-5 divide-right">
                        <div class="images-container bottom_thumb">
                            <div class="product-cover">
                                <img class="js-qv-product-cover img-fluid" src="{{asset($product -> photo)}}" alt="" title="" style="width:100%;margin:10px;" itemprop="image">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7 col-sm-7">
                        ...
                        <div id="product-description-short" itemprop="description">
                            <p><i class="fa fa-circle mr-5"></i>{{$product->description}}</p>
                            @if( $product->short_description !== null )  
                                <p><i class="fa fa-circle mr-5"></i>{{$product->short_description}}</p>  
                            @endif 
